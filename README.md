...
- 2025-02-23 [A Complete Guide to JavaScript DOM Selector Methods](https://dev.to/oeharuki/a-complete-guide-to-javascript-dom-selector-methods-55bb)
...
- 2025-02-11 [Understanding the 4 Principles of WCAG &lpar;Perceivable, Operable, Understandable, Robust&rpar;](https://dev.to/oeharuki/understanding-the-4-principles-of-wcag-perceivable-operable-understandable-robust-2c55)<!-- DEV-TO-POST-LIST:END -->

### Zenn

<!-- ZENN-POST-LIST:START -->
- 2025-02-23 [JavaScriptのDOM要素取得メソッド完全解説](https://zenn.dev/harryduck/articles/javascript-dom-selector-methods-advanced)
...
- 2024-11-27 [大規模なコード変更を小さなPRに分割する Git コマンドたち](https://zenn.dev/harryduck/articles/large-code-changes-into-smaller-prs)<!-- ZENN-POST-LIST:END -->

### note

<!-- NOTE-POST-LIST:START -->
- 2025-07-06 [タコピーは私たちの中にいる【タコピーの原罪】](https://note.com/oe_haruki/n/n2ff80600f510)
